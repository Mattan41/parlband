  ...
  return (
    <>
      ...
      <AdminModal
        open={open}
        title="Ny låt"
        help="Skapa en ny låt i katalogen. Fyll i titel, upphovspersoner och text – id:t (slug) föreslås från titeln och används i filnamn. Efter att låten sparats öppnas den så att du kan lägga upp noter (PDF) och lägga till inspelningar. Med Skapa som utkast sparas låten opublicerad och syns inte på sajten förrän du markerar Publicerad."
        busy={saving}
        onClose={closeModal}
      >
