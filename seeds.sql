...
-- ============================================================================
INSERT INTO recordings (song_id, album, studio, year, engineer, mp3_path, wav_path, cover_path, play_count, is_primary) VALUES
  ('fri', NULL, 'Hemmastudio', 2023, NULL, 'fri.mp3', 'fri.wav', NULL, 0, 1),
  ('som-en-legend', NULL, 'Hemmastudio', 2026, NULL, 'som-en-legend.mp3', 'som-en-legend.wav', NULL, 0, 1),
  ('cohen-och-kent', NULL, 'Hemmastudio', 2022, NULL, 'cohen-och-kent.mp3', 'cohen-och-kent.wav', NULL, 0, 1),
  ('mareld-i-natt', NULL, 'Hemmastudio', 2026, NULL, 'mareld-i-natt.mp3', NULL, NULL, 0, 1),
  ('sommarn-pa-boganeberget', NULL, 'Hemmastudio', 2026, NULL, 'sommarn-pa-boganeberget.mp3', 'sommarn-pa-boganeberget.wav', NULL, 0, 1),
  ('mitt-ute-pa-fryken', NULL, 'Hemmastudio', 2018, NULL, 'mitt-ute-pa-fryken.mp3', 'mitt-ute-pa-fryken.wav', NULL, 0, 1),
  ('klockan-12', NULL, 'Hemmastudio', 2012, 'Erik Walfridsson', 'klockan-12.mp3', NULL, NULL, 0, 1),
  ('slaget-vid-poltava', NULL, 'Hemmastudio', 2018, NULL, 'slaget-vid-poltava.mp3', 'slaget-vid-poltava.wav', NULL, 0, 1);
